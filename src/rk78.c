...
int rk78(double *t, double x[], double *h,
         ...
         int n, int (*field)(int n, double t, double x[], double f[], void *prm),
         void *prm) {
  ...
  static double c[11] = {41. / 840., 0., 0., 0., 0., 34. / 105., 9. / 35., 9. / 35., 9. / 280., 9. / 280., 41. / 840.};
  static double cp[13] = {0., 0., 0., 0., 0., 34. / 105., 9. / 35., 9. / 35., 9. / 280., 9. / 280., 0., 41. / 840., 41. / 840.};
  /* Variables locals */
  int ib, j, k, l, iret;
  ...
  do {
    ...
    for (j = 0; j < 13; j++) {
      ...
      iret = field(n, tt, b /*x*/, r + n * j /*f*/, prm);
      if (iret) return iret;
    }
    dd = d = 0;
    for (l = 0; l < n; l++) {
